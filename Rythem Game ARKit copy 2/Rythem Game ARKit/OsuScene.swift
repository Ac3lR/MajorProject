...
//        ScoreLabel.fontColor = UIColor(hex: 00000000)
...
//        if touchedNode is SKShapeNode && touchedNode.name != "notTarget" || touchedNode is SKLabelNode {    // Runs code if the inside circle was clicked
